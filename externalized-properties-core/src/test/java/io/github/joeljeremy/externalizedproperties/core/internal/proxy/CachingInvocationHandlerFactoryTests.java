...
public class CachingInvocationHandlerFactoryTests {
  ...
  class Constructor {
    ...
    void test1() {
      ...
      assertThrows(
          ...
          () -> new CachingInvocationHandlerFactory(null, cacheStrategy));
    }
    ...
    void test2() {
      assertThrows(
          IllegalArgumentException.class,
          () -> new CachingInvocationHandlerFactory(BASE_INVOCATION_HANDLER_FACTORY, null));
    }
  }
  ...
  class CreateMethod {
    ...
    @Test
    @DisplayName("should return instance of CachingInvocationHandler")
    void test2() {
      InvocationHandlerFactory factory =
          new CachingInvocationHandlerFactory(
              BASE_INVOCATION_HANDLER_FACTORY, new WeakHashMapCacheStrategy<>());
