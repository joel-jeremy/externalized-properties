...
public class ExternalizedPropertiesExceptionTests {
  ...
  class Constructor {
    ...
    void test1() {
      ExternalizedPropertiesException ex = new ExternalizedPropertiesException("My message");
    ...
    void test2() {
      ...
      ExternalizedPropertiesException ex = new ExternalizedPropertiesException("My message", cause);
      assertEquals("My message", ex.getMessage());
