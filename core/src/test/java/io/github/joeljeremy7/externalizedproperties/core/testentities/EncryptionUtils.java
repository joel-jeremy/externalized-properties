...
public class EncryptionUtils {
    ...
    public static KeyPair generateRsaKeyPair(int keySize) {
        try {
            ...
            throw new IllegalArgumentException(
                "Exception occurred while generating RSA key pair.",
                e
            );
        }
    }
    ...
    public static SecretKey generateAesSecretKey(int aesKeySize) {
        try {
            ...
            throw new IllegalArgumentException(
                "Exception occurred while generating AES secret key.",
                e
            );
        }
    }
    ...
    public static AlgorithmParameters createGcmParameters() {
        try {
            AlgorithmParameters algorithmParameters = 
                AlgorithmParameters.getInstance(GCM_ALGORITHM_MODE);
            algorithmParameters.init(createGcmParameterSpec());
            return algorithmParameters;
        } catch (Exception e) {
            throw new IllegalArgumentException(
                "Exception occurred while getting algorithm parameters.",
                e
            );
        }
    }
    ...
    public static byte[] encryptRsa(String value, PublicKey publicKey) {
        try {
            ...
            throw new IllegalArgumentException(
                "Exception occurred while encrypting.", 
                e
            );
        }
    }
    ...
    public static String encryptAesBase64(
        ...
        return Base64.getEncoder().encodeToString(
            encryptAes(value, aesAlgorithm, secretKey)
        );
    }
