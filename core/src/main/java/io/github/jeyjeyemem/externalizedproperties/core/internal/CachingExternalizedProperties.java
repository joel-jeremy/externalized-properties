...
//     /** {@inheritDoc} */
//     @Override
//     public Optional<?> resolveProperty(ProxyMethodInfo proxyMethod) {
//         requireNonNull(proxyMethod, "proxyMethod");

//         String propertyName = proxyMethod.externalizedPropertyName().orElseThrow(
...
//         Optional<?> resolved = decorated.resolveProperty(proxyMethod);
