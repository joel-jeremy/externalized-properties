...
/**
 * A {@link Resolver} implementation which resolves requested properties from resolvers that are
 * loaded from {@link ServiceLoader}.
 */
public class ServiceLoaderResolver extends CompositeResolver {
  /**
   * Constuctor. This will load {@link Resolver} implementations via {@link
