...
public interface InvocationContext {
    /**
     * The {@link ExternalizedProperties} instance that initialized the proxy which 
     * declares the invoked method.
     * 
     * @return The {@link ExternalizedProperties} instance that initialized the 
     * proxy which declares the invoked method.
     */
