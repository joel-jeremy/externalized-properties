 ...
 *
 * @apiNote Processor classes defined in this annotation should be registered via {@link
 *     ExternalizedProperties.Builder#processors(Processor...)} in order for processing to take
 *     place. Otherwise, {@link ExternalizedProperties} will not be able to find an instance for the
 *     processor class will throw an exception.
 */
