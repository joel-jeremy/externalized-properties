...
public class ExternalizedPropertyName {
     ...
     *  </li>
     *  <li>
     *  Otherwise, the proxy method name will be used as externalized property name.
     *  </li>
     * </ol>
     * 
     ...
     * Otherwise, the proxy method name.
     */
    ...
    private static String determineNameFromInvocationArgs(InvocationArguments invocationArgs) {
        ...
        Optional<String> nameFromArguments = invocationArgs.get(0)
