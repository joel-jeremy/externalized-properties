...
public interface ProxyMethod {
    ...
    /**
     * <p>The proxy method return type's generic type parameters, if the return type is 
     * a parameterized type e.g. {@code List<String>}. 
     * 
     * <p>For example, if {@link #returnType()} returns a parameterized type e.g. 
     * {@code List<String>}, this method shall return an array containing a {@code String} 
     * type/class.
     * 
     * <p>Another example is if {@link #returnType()} returns an array whose component type 
     * is a parameterized type e.g. {@code Optional<Integer>[]}, this method shall return an 
     ...
     * parameterized type.
     * 
     * @return The generic return type parameters, if the return type is a parameterized type 
     * e.g. {@code Optional<String>}. Otherwise, an empty array.
