...
/** Benchmark property conversion via proxy or directly from {@link ExternalizedProperties}. */
...
public abstract class ConversionBenchmarks {
  ...
  public static class BenchmarkState {
    ...
    public void setup() throws NoSuchMethodException, SecurityException {
      ...
      proxyInterfaceWithEagerLoading =
          externalizedPropertiesWithEagerLoading.initialize(ConversionProxyInterface.class);
      ...
      proxyInterfaceWithInvocationCaching =
          externalizedPropertiesWithInvocationCaching.initialize(ConversionProxyInterface.class);
    }
  }
  ...
  /**
   * Benchmark resolution of properties from a proxy interface with proxy eager loading enabled and
   * conversion to int.
   *
   * @param state The benchmark state.
   * @return For you, blackhole.
