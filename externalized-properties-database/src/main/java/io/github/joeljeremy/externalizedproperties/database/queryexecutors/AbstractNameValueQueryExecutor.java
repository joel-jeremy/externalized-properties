...
public abstract class AbstractNameValueQueryExecutor implements QueryExecutor {
  ...
  public Map<String, String> queryProperties(
    ...
    PreparedStatement preparedStatement = prepareStatement(connection, propertyNamesToResolve);
  ...
  protected void configureStatementParameters(
      PreparedStatement preparedStatement, Collection<String> propertyNamesToResolve)
      throws SQLException {
    int i = 1;
