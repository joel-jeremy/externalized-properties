package io.github.joeljeremy.externalizedproperties.git.testentities.resourcereaders;
...
public class JsonReader implements ResourceReader {
  ...
  public Map<String, Object> read(String resourceContents) throws IOException {
    return objectMapper.readValue(resourceContents, new TypeReference<Map<String, Object>>() {});
  }
}
