...
public class AbstractNameValueQueryExecutorTests {
  ...
  static final String PROPERTY_NAME_COLUMN =
      SimpleNameValueQueryExecutor.DEFAULT_PROPERTY_NAME_COLUMN;
  static final String PROPERTY_VALUE_COLUMN =
  ...
  static final String H2_CONNECTION_STRING =
      H2Utils.buildConnectionString(AbstractNameValueQueryExecutorTests.class.getSimpleName());
