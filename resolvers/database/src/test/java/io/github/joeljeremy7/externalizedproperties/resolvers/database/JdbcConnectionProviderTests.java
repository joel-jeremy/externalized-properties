...
public class JdbcConnectionProviderTests {
    ...
    public static void setup() throws SQLException {
        ...
        H2Utils.createUser(
            H2_DATA_SOURCE.getConnection(), 
            CUSTOM_H2_USER, 
            CUSTOM_H2_USER_PASSWORD
        );
    }
    ...
    class GetConnectionMethod {
        ...
        @Test
        @DisplayName(
            "should get a connection from data source with the given username"
        )
        ...
        @Test
        @DisplayName(
            "should throw when invalid username was used"
        )
        ...
        @Test
        @DisplayName(
            "should throw when invalid password was used"
        )
        ...
        @Test
        @DisplayName(
            "should get a connection from driver manager with the given user in properties"
        )
        ...
        @Test
        @DisplayName(
            "should throw when properties contain an invalid user"
        )
        ...
        @Test
        @DisplayName(
            "should throw when properties contain an invalid password"
        )
