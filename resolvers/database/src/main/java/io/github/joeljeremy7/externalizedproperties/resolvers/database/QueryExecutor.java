 ...
 *
 * @apiNote As best practice, implementations should set the max results on the query to be used in
 *     order to efficiently handle resolution of properties from the database.
 */
public interface QueryExecutor {
  ...
  Map<String, String> queryProperties(
      Connection connection, Collection<String> propertyNamesToResolve) throws SQLException;
}
