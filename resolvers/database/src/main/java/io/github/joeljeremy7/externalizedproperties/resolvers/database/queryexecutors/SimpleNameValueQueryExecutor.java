 ...
 *     For example, if {@link #table()} value is to be overriden, the {@code io.github.joeljeremy7
...
public class SimpleNameValueQueryExecutor extends AbstractNameValueQueryExecutor {
   ...
   * unless overriden via the {@code io.github.joeljeremy7.externalizedproperties.resolvers
   ...
   * externalized_properties} unless overriden via the {@code io.github.joeljeremy7
   ...
   * {@code property_name} unless overriden via the {@code io.github.joeljeremy7
   * .externalizedproperties.resolvers.database.queryexecutors.SimpleNameValueQueryExecutor
   ...
   * {@code property_value} unless overriden via the {@code io.github.joeljeremy7
   * .externalizedproperties.resolvers.database.queryexecutors.SimpleNameValueQueryExecutor
